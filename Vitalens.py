...
measures_layout = pn.Column(textMeasureSupp, ButtonSmallWells,textCloseNatura, ButtonCloseNatura, textImport, ButtonImportWater,  textIndustrial, ButtonAddExtraIndustrial, spacer(10), textMeasureDemand, ButtonDemand, textEnd, ButtonReset, width=320)
...
tabTop = pn.Tabs(("1. Scenarios", scenario_layout), ("2. Measures", measures_layout), closable=True, width = 320)
...
map_pane = pn.pane.plot.Folium(update_layers(), sizing_mode="scale_both")
...
right_pane = pn.Column(excess_cap,industrial_extract)
...
keukenhofs = pn.bind(generate_area_SVG, natura_value)
keuk_text = pn.pane.HTML("<p style='font-size: small;'>Represented in number of Keukenhof parks")
natura_pane = pn.Column(natura_value, keukenhofs, keuk_text, sizing_mode='scale_both')
...
indicatorsArea = pn.Tabs(lzh, *balance_lzh_gauges.values(), align=("center", "center"), sizing_mode="scale_height")
...
Supp_dem =  pn.Row(
    total_extraction, minusSVG, total_demand, equalSVG, total_difference)
...
main2[0,0:2] = pn.Column(
    indicatorsArea, textDivider0, Supp_dem, textDivider1, natura_pane,
    sizing_mode="scale_width",
    scroll=True
)
main2[0,2] = pn.Column(
    Env_pane, right_pane, pipes_pane,
    sizing_mode="scale_width",
    scroll=True
)
