...
def update_scenarioTitle(new_title):
    ...
    if Scenario_Button.value == "Population 2035 +1% increase":
        ...
        if base_title in text:
            text.remove(base_title)
        text.append(new_title)
    if Scenario_Button.value == "Population - 2022":
        if "Accelerated Growth" in text:
            text.remove("Accelerated Growth")
        if "Autonomous Growth" in text:
            text.remove("Autonomous Growth")
...
natura_pane = pn.Column(natureDamage_TT, natureHighDamage_value,  spacer(10),keukenhofsHigh,  natureMidDamage_value, spacer(50),keukenhofsMid, keuk_text)
